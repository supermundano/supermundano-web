      ...
      <Page ogTags={ogTags} canonicalURL="/cookies">
        <ServicesTextSectionStyle>
          ...
          <div className="text">
            ...
            <p>We only use cookies provided by trusted third parties. The following section details which third party cookies you might encounter through this site.</p>
            ...
            <p>However if you are still looking for more information then you can contact us by email here: <a href="mailto:hello@blavetstudio.com" target="_blank" rel="nofollow noopener noreferrer">hello@blavetstudio.com</a></p>
